        ...
        <div class="page-header-content pt-4 d-flex justify-content-between align-items-center">
            <h1 class="page-header-title">
                <div class="page-header-icon">
                    <i data-feather="pause-circle" style="margin-right: 0.25em;"></i> <!-- Adjust margin-right as needed -->
                </div>
                Dashboard: Pending
            </h1>
...
<div class="container mt-4">
 ...
 <!-- Include quartetCard view and pass counts data -->
 @include('contacts.cards.quartetCard', ['counts' => $counts])
 <div class="card mb-4">
        <!-- Card header with search bar -->
        <div class="card-header" style="background-color: #F4A100; color: white; border-bottom: 0; display: flex; justify-content: space-between;">
            <div>
