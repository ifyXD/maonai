...
@push('scripts')
    ...
    <script>
        ...
        <td id="driverId${vehicle.id}"> ${vehicle.driver_name}</td>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="driver" id="editdriver${vehicle.id}" class="form-control">
                                        <option value="" selected>Select Driver</option>
                                    @foreach ($drivers as $driver) 
                                        <option value="{{ $driver->id }}" ${vehicle.did == {{ $driver->id }} ? 'selected' : '' }>{{ $driver->driver_name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="mb-3">
