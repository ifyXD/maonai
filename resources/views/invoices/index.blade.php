                ...
                <div class="container">
                        ...
                        <div class="card-header p-4 p-md-5 border-bottom-0 green-yellow-gradient text-white light-green-border">
                            <div class="row justify-content-between align-items-center">
                                <div class="col-12 col-lg-auto mb-5 mb-lg-0 text-center text-lg-left">
                                    <h2 class="text-white mb-0">Invoice Profile:</h2>
                                </div>
                                <div class="col-12 col-lg-auto text-center text-lg-right">
                                    <!-- Invoice details-->
                                    <div class="h3 text-white">{{ $contact->name }}</div>
                                    #00{{ $contact->id }}
                                    <br />
                                    January 1, 2020
                                </div>
                                ...
                                <div class="col-md-4 d-flex justify-content-end align-items-center">
                                    <div class="text-center d-flex flex-column align-items-start" style="width: 100%;"> <!-- Set width for the container -->
                                        ...
                                        <div class="mb-2 option-container d-flex align-items-center">
                                            ...
                                            <button class="btn btn-success rounded-circle mr-2" id="contact-dashboard" title="Go to Contact Dashboard" style="width: 60px; height: 60px;"> <!-- Adjust width and height -->
                                                <i data-feather="home" class="fs-4"></i> <!-- Replace "home" with your chosen icon name, and fs-4 class to make it larger -->
                                            </button>
                                            <!-- Label for Contact Dashboard -->
                                            <p class="mb-0">|Contact Dashboard</p>
                                        </div>
                                        ...
                                        <div class="mb-2 option-container d-flex align-items-center">
                                            ...
                                            <p class="mb-0">|Print to PDF</p>
                                        </div>

                                        <!-- Option 3: Print to Word -->
                                        <div class="mb-2 option-container d-flex align-items-center">
                                            <!-- Button for printing to Word -->
                                            <button class="btn btn-primary rounded-circle mr-2" id="print-word-button" title="Print to Word" style="width: 60px; height: 60px;"> <!-- Adjust width and height -->
                                                <i data-feather="file-text" class="fs-4"></i> <!-- Replace "file-text" with your chosen icon name, and fs-4 class to make it larger -->
                                            </button>
                                            <!-- Label for printing to Word -->
                                            <p class="mb-0">|Export to Word</p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="card mb-4 labors-card">
                        <div class="card-header p-4 p-md-5 border-bottom-0 green-yellow-gradient text-white light-green-border">
                            <div class="row justify-content-between align-items-center">
                                <div class="col-12 col-lg-auto mb-5 mb-lg-0 text-center text-lg-left">
                                    <h2 class="text-white mb-0">Labors Needed</h2>
                                    <p>Associated Manpower</p>
                                </div>
                                <div class="col-12 col-lg-auto text-center text-lg-right">
                                    <!-- Insert button for labors -->
                                    <a href="{{ route('invoices.createLabors', ['contact_id' => $contact->id]) }}" class="btn btn-primary">Insert Labor</a>
                                </div>
                            </div>
                        </div>
                        <!-- Invoice content -->
                    ...
                    <div class="card mb-4 materials-card">
                        <div class="card-header p-4 p-md-5 border-bottom-0 green-yellow-gradient text-white light-green-border">
                            <div class="row justify-content-between align-items-center">
                                <div class="col-12 col-lg-auto mb-5 mb-lg-0 text-center text-lg-left">
                                    <h2 class="text-white mb-0">Materials</h2>
                                    <p>Supplies & Hardware</p>
                                </div>
                                <div class="col-12 col-lg-auto text-center text-lg-right">
                                    <!-- Insert button for materials -->
                                    <a href="{{ route('invoices.createMaterials', ['contact_id' => $contact->id]) }}" class="btn btn-primary">Insert Material</a>
                                </div>
                            </div>
                        </div>
                        <!-- Invoice content -->
