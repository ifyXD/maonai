    ...
    <div class="container mt-n10">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="datatable">
                        <div class="modal fade" id="addNewfuel" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <form>
                                    @csrf
                                    <div class="modal-content create-new-vehicle-content">
                                        <div class="modal-header">
                                            <h1 class="modal-title fs-5" id="exampleModalLabel">Create new Fuel Record</h1>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-1">
                                                ...
                                                <input type="number" class="form-control" id="fuel_quantity" name="fuel_quantity" placeholder="Fuel Quantity" required>
                                            </div>
                                
                                            <div class="mb-1">
                                                <label for="fuel_cost" class="form-label">Fuel Cost</label>
                                                <input type="number" class="form-control" id="fuel_cost" name="fuel_cost" placeholder="Fuel Cost" required>
                                            </div>
