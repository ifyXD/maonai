    ...
    <script>
        ...
        $.ajax({
            ...
            success: function(data) {
                // Assuming data is an array of driver objects
                $.each(data.drivers, function(index, driver) {
                    var key = index + 1;
                    var ifdel = driver.isdel === 'isdel' ? 'is-deleted' : '';
                    ...
                    let row = `
                        <tr class="${ifdel}" id="trId${driver.id}">
                            ...
                            <td>${formatDate(driver.updated_at)}</td>
                            <td>
                                ${action}
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body"> 
                                ...
                                <div class="mb-3">
                                    <label for="editdemail${driver.id}" class="form-label">Email</label>
